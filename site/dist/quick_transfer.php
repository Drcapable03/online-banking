    ...
    <body data-topbar="dark" data-layout="horizontal">
        ...
        <div id="layout-wrapper">
            ...
            <?php
                ...
                $customer_nav_page = 'quick_transfer';
...
<?php
    ...
    if(isset($_REQUEST['btn_submit']))
    {
        ...
        else
        {
            ...
            $To_account = (int) $_REQUEST['txt_ben_account_no'];
            ...
            try {
                ...
                $debit_stmt->bind_param('iii', $Amount, $Account_no, $Amount);
                $debit_stmt->execute();
                ...
                $debit_insert->bind_param('sissiii', $Trans_date, $Amount, $debit_type, $Purpose, $To_account, $Account_no, $from_bal);
                ...
                $credit_insert->bind_param('sissiii', $Trans_date, $Amount, $credit_type, $Purpose, $Account_no, $To_account, $to_bal);
                ...
                mysqli_rollback($con);
                echo '<script type="text/JavaScript">lowBalance();</script>';
            }
        }
    }
?>