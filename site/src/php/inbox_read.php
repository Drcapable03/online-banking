<?php
    ...
    if ($row_request['hasViewed'] != 1) {
        ...
        mysqli_query($con, $query_for_update_hasviewed);
    }
?>
                                            ...
                                            <div class="btn-group ml-md-2 mb-3">
                                                ...
                                                <?php 
                                                    if($row_request['status'] != 'sent')
                                                    {
                                                        ...
                                                        <input type="submit" class="btn btn-primary waves-effect waves-light mt-2 mr-3" name="btn_send_money" value="Send '.$Currency_symbol.' '.$amount.'"/>
                                                    </form>';
                                                    }
                                                    else
                                                    {
...
<?php
    if(isset($_REQUEST['btn_send_money']))
    {
        ...
        } elseif ($result['error'] === 'already_sent') {
            echo '<script type="text/JavaScript">alert("This request has already been fulfilled.");</script>';
        } else {
