...
$page_title = 'Routing Numbers';
$page_heading = 'Routing Numbers';
$stub_message = 'View your routing and account numbers for direct deposit and wire transfers.';
$stub_phase = 'Phase 2';
$customer_nav_section = 'accounts';
$customer_nav_page = 'routing';
