    ...
    <body data-topbar="dark" data-layout="horizontal">
        ...
        <div id="layout-wrapper">
            ...
            <?php
                ...
                $customer_nav_page = 'send_requests';
                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_array($request_result)) {
                                                        ...
                                                        <div class="col-mail col-mail-2">
                                                            <a href="send_requests_read.php?request_id='.$row['request_id'].'" class="subject"><span class="'.$badge_color.' badge mr-2">'.$Currency_symbol.' '.$row['amount'].'</span>'.$row["message"].'
                                                            </a>
